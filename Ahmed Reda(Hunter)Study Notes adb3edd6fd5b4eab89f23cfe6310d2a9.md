...
![Screenshot_2023-03-09_06_50_09.png](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Screenshot_2023-03-09_06_50_09.png)
...
![we can add credintials like user and pass we want login with by -u but the credits have to be clear txt form](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Screenshot_2023-03-09_06_47_45.png)
...
![Screenshot_2023-03-09_08_12_14.png](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Screenshot_2023-03-09_08_12_14.png)
...
![Screenshot_2023-03-09_08_18_39.png](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Screenshot_2023-03-09_08_18_39.png)
...
![Screenshot_2023-03-09_10_47_58.png](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Screenshot_2023-03-09_10_47_58.png)
...
![Screenshot_2023-03-09_10_56_10.png](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Screenshot_2023-03-09_10_56_10.png)
...
![Screenshot_2023-03-09_11_24_55.png](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Screenshot_2023-03-09_11_24_55.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%201.png)
...
- **LLMNR Poisoning :**  User type something wrong and this cause issue with DNS and DNS can’t resolve so decided to send a broad cast message to anybody know who it this and we set in middle and saying we know what you ‘re looking for and **send me your hash and  I will get you connected.**
    ...
    ![164.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/164.jpg)
...
- **Using Responder tool to make LLMNR Poisoning** (Responds to these request - You need a lot of traffic with this tool - Listening and not generating much traffic as Nmap so it’s the first step) - Event happens (Failing DNS in any way ) then Get Hash and username of what we captured - Crack the hash (hashcat -m 5600 hashes.txt rockyou.txt) **:**
    ...
    ![164.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/164%201.jpg)
...
- Responder in the wild - This tool using for different poisoners  :
    - **rwd :** this saying these are different types of what we ‘re gonna be listening on.
        ...
        ![170.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/170.jpg)
        
    - Hash of machine we are attacking :
        
        ![171.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/171.jpg)
        
    - hashcat -m 5600(cracking type) (folder name) (wordlist) - -force.
- **Defenses : LLMNR fails goes to DNS and the opposite is right.**
    
    ![172.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/172.jpg)
...
- **SMB Relay :** SMB signing is a packet level protocol and if SMB signing is enables when we try to relay credentials and it’s going to say hey you’re not really that person **( As packets not sign by you ) and When SMB disables , it never checks for that - The user being relayed has to have admin credentials on that machine -** Should happen on 2 **different(separate)** machines not on the same machine - **Take captured hash relay it over to another machine where is also an admin** and do malicious things to that machine - Listening but not responding to SMB and HTTP server.
    ...
    ![173.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/173.jpg)
...
- Using ntlmrelayx.py to do relay attack and set target :
    ...
    ![175.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/175.jpg)
    
- **Received connection from machine and connect to another machine :**
    
    ![176.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/176.jpg)
...
- **Remember fcastle here is an administrator of 2 machines** - **Now we have dumped SAM Hashes which like shadow file on Linux - With these hashes like gaining shells and getting access - This attack is by design ( many Local admins on different machines)  :**
    ...
    ![178.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/178.jpg)
    
- **Getting interactive shell (SMB shell) using SMB Relay attack  :**
    
    ![179.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/179.jpg)
    
    ![180.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/180.jpg)
    
- We have many options like -c to execute specific command on the machine :
    
    ![181.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/181.jpg)
    
- **Remember we must trigger this event.**
- **Defense :**
    
    ![182.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/182.jpg)
...
- **Gaining Shell Access : All we have is credential  - I**f we have SMB open and we have a username and password , we can use this user **especially that user has a machine and their local administrator to get a shell using psexec.**
    - **Using psexec with metasploit - Set subdomain & smbpass :**
        ...
        ![183.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/183.jpg)
        
    - Get a shell using [psexec.py](http://psexec.py)  and more different options to get shell:
        
        ![184.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/184.jpg)
...
- **Running the Attack using mitm6 :**
    ...
    ![185.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/185.jpg)
...
- Set a loot to be able to dump some information , **-wh fakewpad.marvel.local -** Shutting computer down and restart it make ipv6 asks who gets my DNS instead of asking every 30 min.**:**
    ...
    ![189.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/189.jpg)
    
    ![186.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/186.jpg)
    
    ![187.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/187.jpg)
...
- This domain user by group .html gives me some information that be seen as it is invisible ( Succeed with **a computer (Windows 10 machine)** capable of accessing this domain controller via LDAPS **logging into it and dumping out any useful information**) :
    ...
    ![188.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/188.jpg)
...
- When an admin try to log in the computer and attacking target LDAP and then it comes through and it tries to make a new user for us . First , it setup access control for us and then tries to **create new user saying there is username and password and now we are on domain** :
    ...
    ![190.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/190.jpg)
    
    ![191.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/191.jpg)
    
    ![192.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/192.jpg)
    
    - **New user in the domain and we have policy to have exclusive privileges with that access control  :**
        
        ![194.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/194.jpg)
        
    - **To restore the old policy we have a file with older ACL ( After attack we create new ACL)  :**
        
        ![195.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/195.jpg)
...
- **Defense :**
    ...
    ![196jpg.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/196jpg.jpg)
...
- **Combining Attacks against AD :**
    ...
    ![197.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/197.jpg)
...
- **Bypass execution policy using powershell - Ready for executing scripts :**
    ...
    ![198.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/198.jpg)
    
- **Up powerview to enumerating the domain :**
    
    ![199.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/199.jpg)
    
- **Get information about the domain ( where are domain controllers and much more) :**
    
    ![200.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/200.jpg)
    
- **Get information about domain controllers ( Name , ip and much more) :**
    
    ![201.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/201.jpg)
    
- **Get the domain policy :**
    
    ![202.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/202.jpg)
...
- **Get detailed information about system access of the policy** ( Note the Minimum password length and how to use this information or password complexity all these information open ways for hacker) :
    ...
    ![203.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/203.jpg)
    
- Get net users ( **Get data about users in domains , you can find interesting description with passwords sometimes** ) :
    
    ![204.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/204.jpg)
    
    ![205.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/205.jpg)
    
    - Filtering outputs to do it more easily.
- **Get the property the user might have :**
    
    ![206.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/206.jpg)
    
    ![207.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/207.jpg)
    
    - Get a specific property of item we want ( like password last list).
    
    ![208.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/208.jpg)
    
    - logoncount property which can identify **honeybot accounts.**
    
    ![209.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/209.jpg)
...
- **List all computers on the domain :**
    ...
    ![210.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/210.jpg)
    
    ![211.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/211.jpg)
    
    - for more information and as before you select specific property like OperatingSysetm ( Greb feature).
- **Get information about groups :**
    
    ![212.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/212.jpg)
    
    ![213.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/213.jpg)
    
    ![214.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/214.jpg)
    
                                            **Get all admin groups using wild card.**
    
    ![215.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/215.jpg)
    
    - Get information about specific member in the group.
- **Get all SMB sharing in the network :**
    
    ![217.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/217.jpg)
    
- **Get all group policy :**
    
    ![218.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/218.jpg)
    
    ![219.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/219.jpg)
...
- Run a tool called neo4j and we should to set it up - change default credentials- Go to local host to change default password for more security :
    ...
    ![220.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/220.jpg)
...
- ****Invoke-Bloodhound :**** power shell tool using for grabbing data - Downloading this file on Windows 10 machines ( which you get access from previous stage).
    - **To be able to use scripts :**
        ...
        ![221.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/221.jpg)
        
    - **Running sharphound :**
        
        ![22.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/22.jpg)
        
    - **Running the script to get data collection from specific domain - Get this file copied to kali machine  :**
        
        ![222.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/222.jpg)
...
- Now we have our data transferred from our windows machine ( we get in the last phase) to Bloodhound - Processing all json file  :
    ...
    ![223.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/223.jpg)
...
- **Pass the password and try to pwn machines in the subnet :**
    ...
    ![224.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/224.jpg)
    
- **Using Metasploit using psexec module  :**
    
    ![2252.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/2252.jpg)
    
    ![226.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/226.jpg)
...
- **Crackmapexec :**
    ...
    - When crackme doesn’t give me (pwn3d!) , this means that this password work and passing has succeed and if it ‘not pwn3d! this means that **user doesn’t have SMB access to the domain controller.**
        ...
        ![227.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/227.jpg)
        
    - **This will try to dump SAM file , sometimes it works and sometimes it doesn’t.**
        
        ![228.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/228.jpg)
        
    - And this will make us on authority system of another machine ( spiderman machine) and this will give us some information.
        
        ![230.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/230.jpg)
...
- ****Dumping Hashes with [secretsdump.py](http://secretsdump.py) :**
    ...
    - **Getting hash dump - Dumping SAM , LSA and DPAPI key hashes - With 2 machines with eyes we can see if same hash shows up more than once :**
        ...
        ![231.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/231.jpg)
...
- ****Cracking NTLM Hashes with Hashcat :****
    ...
    - **NTLM hashes can be passed NTLM B2 hashes cannot.**
        ...
        ![232.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/232.jpg)
    ...
    - Get hashes - **Success in green plus** :
        ...
        ![233.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/233.jpg)
    ...
    - We can use these hashes and try to gain shell using [psexec.py](http://psexec.py) (Here we need all hashes NTLM and LLMNR) :
        - Here we aren’t able to get any admin access via this one , although user can get access to the machine **we can’t get writeable share where you can upload and and get shell.**
            ...
            ![234.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/234.jpg)
            
- ****Mitigations :****
    
    ![235.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/235.jpg)
...
- Token as cookies as they are temporary keys allow you access to a system or network without actually having to provide your credentials .
    ...
    ![236.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/236.jpg)
    
- Here we have user and get the shell (we ‘re shell here in meterpter) using tool called **Incognito in Metasploit.**
    
    ![237.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/237.jpg)
    
- **Token Impersonation :**
    
    ![238.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/238.jpg)
    
- Using Invoke-Mimikatz **powershell script** to dump the hashes :
    
    ![239.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/239.jpg)
    
- **If a Domain Admin token was available :**
    
    ![240.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/240.jpg)
    
    ![242.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/242.jpg)
    
    ![243.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/243.jpg)
...
- Setting options for begin the exploitation (set RHOSTS , LHOSTS **,payload**) :
    ...
    ![246.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/246.jpg)
    
    ![245.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/245.jpg)
    
    - Get meterpeter session and get shell to the machine
    
    ![248.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/248.jpg)
    ...
    - **After we impersonate a token , we try to add user , local groups and etc -List tokens and get token for specific user and finally get the shell on this mcahine :**
        ...
        ![250.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/250.jpg)
...
- Domain controllers is called as key distribution center (KDC) - We request for TGS (from service) using our TGT we get from previous stage - We receive TGS hashed by server.
    ...
    ![251.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/251.jpg)
...
- Valid user account which gives a ticket granting (Steps 1 , 2) , then we can request a service ticket for a service and service ticket is going to **be encrypted with these servers account hash (Crack the hash).**
    ...
    ![252.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/252.jpg)
...
- All we need in this attack is username and password from **a domain account ( domain we are interested in) - Service account shouldn’t be domain admin :**
    ...
    ![253.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/253.jpg)
...
- **URL attack :**
    - This ip address will go to be attacker ip address to catch the hash :
        ...
        ![254.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/254.jpg)
        
    - Save this file in share folder :
        
        ![255jpg.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/255jpg.jpg)
        ...
        ![256.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/256.jpg)
    ...
    - To make this file at the top of the folder in file share folder and this ensures that it loads . **Note the filename and save as type.**
        ...
        ![257.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/257.jpg)
        
        - Using Responder to get the hash.
        
        ![258.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/258.jpg)
    ...
    - ****PrintNightmare (CVE-2021-1675) - Using Metasploit (msvenom) to create malicious dll to preform the attack “Generating payload”  :****
        ...
        ![273.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/273.jpg)
        
        ![274.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/274.jpg)
        
        ![275.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/275.jpg)
...
- Using for Dump credentials on windows , extract plaint text password , PIN code and Kerbors tickets **from memory** - **This tool can get up with windows then the tool get patched and go back and forth** :
    ...
    ![259.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/259.jpg)
...
- **MimiKatz on Domain controller -Credential Dumping with Mimikatz :**
    - **Downloading and Exteracting mimikatz- there are different module on mimikatz with different potentials :**
        ...
        ![260.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/260.jpg)
    ...
    - First part in the command is the module (privilege::debug) to have debug on to bypass memory protections that are in the place especially for lsass.exe  - Dump information out of memory.
        ...
        ![261.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/261.jpg)
    ...
    - **Some attacks (Different options) to do the last we talked about :**
        - Dumping this for domain controller or regular computer are going to show us the computer username and NTLM (can be bypassed) hash for that and as well as any user that has logged since last reboot and that’s stored here in memory - **Take advantage of wdigest.**
            ...
            ![262.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/262.jpg)
            
        - Trying to dump SAM file (Another way if we can’t do that here we have different ways ) -**Might work** :
            
            ![263.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/263.jpg)
        ...
        - **Dump LSA information - This dump is important as we can took this and crack it offline ( what percentage can we crack) a**s this number will relay back to client to tell him about password policy (If it strong or weak) “How Bad is you policy is” (Pentest Approach) -NTLM here for kerbros granting ticket and this will help in golden ticket attack  :
            ...
            ![264.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/264.jpg)
...
- ****Golden Ticket Attacks :****
    ...
    - **Doing injection and pull down the actual user we wan not all users :**
        ...
        ![265.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/265.jpg)
        ...
        - We need SID of the domain , NTLM hash for kerbros TGT , then **using kerbros and it doesn’t have to be real user - Getting familiar with id accounts to use it - ptt for passing the ticket - This will generate golden ticket and pass that ticket along to our nest session or current :**
            ...
            ![266.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/266.jpg)
            
            ![276.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/276.jpg)
            
        - **Get Command prompt - we can use psexec  installed and gain access to the machine you want :**
            
            ![277.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/277.jpg)
...
- Attack phases :
    - **Check if our domain controller vulnerable for zerlogon attack :**
        ...
        ![267.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/267.jpg)
        
    - You should take care of not destroying the domain controller in real scenario if you fully sure to restore AD so  it :
        
        ![268.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/268.jpg)
        
    - After exploiting we will dump and do what we need to domain controller (Last phase here) :
        
        ![269.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/269.jpg)
...
- Restore the machine -Using Administrator hash and get the clear password of it then use it with [restorepassword.py](http://restorepassword.py) - Looked for plain password hex as this will be used for restoring domain controllers   and Remember take down domain controller is very dangerous :
    ...
    ![270.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/270.jpg)
    
    ![271.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/271.jpg)
    
    ![272.jpg](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/272.jpg)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%202.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%203.png)

![receiving connections ](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%204.png)

receiving connections 

![crashed](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%205.png)

crashed

here we can see it’s crashed at what point

![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%206.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%207.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%208.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%209.png)

![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2010.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2011.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2012.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2013.png)

![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2014.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2015.png)

after we ran the script we should see that the EIP in a breakpoint and has been controlled 🤠😮‍💨 

![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2016.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2017.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2018.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2019.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2020.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2021.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2022.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2023.png)

```bash
route print
```

![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2024.png)

```bash
netstat -ano
```

![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2025.png)

**in linux**:

![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2026.png)
...
![Untitled](Ahmed%20Reda(Hunter)Study%20Notes%20adb3edd6fd5b4eab89f23cfe6310d2a9/Untitled%2027.png)
